      ...
      <View style={{ flexDirection: 'row', gap: 14, marginBottom: 28 }}>
        ...
        >
          <View style={{
            ...
            <Text style={{ fontSize: 20, color: selectedMode === 0 ? '#ffffff' : '#3b82f6' }}>📡</Text>
          </View>
          <Text style={{ 
            fontSize: 13, 
            fontWeight: '800', 
        ...
        >
          <View style={{
            ...
            <Text style={{ fontSize: 20, color: selectedMode === 1 ? '#ffffff' : '#a855f7' }}>🧪</Text>
          </View>
          <Text style={{ 
            fontSize: 13, 
            fontWeight: '800', 
                  ...
                  networks.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {item.secured && <Text style={{ fontSize: 12, color: '#cbd5e1' }}>🔒</Text>}
                      </TouchableOpacity>
                    );
                  })
                ) : (
